...
from hoct.inference import EdgeModel, model_predict
...
def create_graph_from_points(
    ...
    --------
    >>> import polars as pl
    >>> from hoct import create_graph_from_points
    >>>
    >>> # Create 2D points
    >>> points = pl.DataFrame(
    ...     {
...
def predict(
    ...
    *,
    ...
    1. Creates candidate tracking graph from labels using hoct.features.create_graph
